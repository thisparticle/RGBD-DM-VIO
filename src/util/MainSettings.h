...
public:
    ...
    //2022.08.31 czq
    // void parseROSArguments(int argc, char** argv, SettingsUtil& settingsUtil,std::string settingsFile);
    void parseROSArgument(SettingsUtil& settingsUtil, std::string settingsFile);
    //2022.08.31 czq
